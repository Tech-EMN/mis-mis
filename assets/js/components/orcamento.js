    ...
    const load = async () => {
      try {
        ...
        setProject({
          ...
          source_type: 'dxf',
          status: 'done',
          total_rooms: 4, total_area_m2: 450.0,
          rooms: [
            ...
            { name: 'Ambiente Externo', area_m2: 200.0, perimeter_m: 90.0, width_m: 40.0, length_m: 5.0, shape: 'irregular', confidence_geometry: 0.88, confidence_name: 0.70, faces: [{ label: 'piso', area_m2: 200.0 }, { label: 'teto', area_m2: 200.0 }, { label: 'paredes', area_m2: 252.0 }] },
            { name: 'Ambiente Interno', area_m2: 25.0, perimeter_m: 20.0, width_m: 5.0, length_m: 5.0, shape: 'rectangle', confidence_geometry: 1.0, confidence_name: 0.95, faces: [{ label: 'piso', area_m2: 45.0 }, { label: 'teto', area_m2: 45.0 }, { label: '{ label: 'paredes', area_m2: 56.0 }]o/drywall) requerem PDF + Claude Vision'],
          fragilities: [],
          elapsed_ms: 3500,
