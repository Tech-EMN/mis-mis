      ...
      try {
        ...
        setProject({
          ...
          rooms: [
            ...
            { name: 'Ambiente Interno', area_m2: 25.0, perimeter_m: 20.0, width_m: 5.0, length_m: 5.0, shape: 'rectangle', confidence_geometry: 1.0, confidence_name: 0.95, faces: [{ label: 'piso', area_m2: 25.0 }, { label: 'teto', area_m2: 25.0 }, { label: 'paredes', area_m2: 56.0 }] },
          ],
